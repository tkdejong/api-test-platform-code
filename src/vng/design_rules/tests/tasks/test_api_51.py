...
class Api51Tests(TestCase):
    def test_design_rule_already_exists(self):
        ...
        result = run_api_51_test_rules(session, "https://maykinmedia.nl/", is_json=True)
    ...
    def test_base_as_first_path(self):
        ...
        result = run_api_51_test_rules(session, "https://maykinmedia.nl/api/v1", is_json=True)
        self.assertEqual(DesignRuleResult.objects.count(), 1)
    ...
    def test_is_not_json_parsed(self):
        ...
        result = run_api_51_test_rules(session, "https://maykinmedia.nl/api/v1", is_json=False)
        self.assertEqual(DesignRuleResult.objects.count(), 1)
        self.assertFalse(result.success)
