...
urlpatterns += [
    ...
    path('testsessions/<uuid:uuid>/stop/', api_views.StopSessionView.as_view(), name='stop_session'),
    path('testsessions/<uuid:uuid>/result/', api_views.ResultSessionView.as_view(), name='result_session'),
    path('testsessions/<uuid:uuid>/stop/', api_views.StopSessionView.as_view(), name='stop_session'),
    path('testsessions/<uuid:uuid>/result/', api_views.ResultSessionView.as_view(), name='result_session'),
]
