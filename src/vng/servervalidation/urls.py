...
urlpatterns = [
    ...
    path('<uuid:uuid>/schedule/', views.CreateSchedule.as_view(), name='server-run_create_schedule'),
    path('<uuid:uuid>/schedule/activate/', views.ScheduleActivate.as_view(), name='schedule_activate'),
