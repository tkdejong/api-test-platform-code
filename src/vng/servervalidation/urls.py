...
urlpatterns = [
    path(':arrow_up:testscenario/<int:pk>', views.SessionTypeDetail.as_view(), name='testscenario-detail'),
    ...
    path('<uuid:uuid>/log', views.ServerRunLogView.as_view(), name='server-run_detail_log'),
    path('<uuid:uuid>/pdf', views.ServerRunPdfView.as_view(), name='server-run_detail_pdf'),
